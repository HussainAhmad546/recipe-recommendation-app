...
//           <h1 className="text-4xl font-bold text-center mb-4">{recipe.question}</h1>
//           <div className="flex justify-center mb-6">
//             <img src={recipe.image || 'default_image_url'} alt={recipe.question} className="rounded-lg shadow-lg w-full" />
//           </div>
