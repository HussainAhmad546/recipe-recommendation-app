...
//                             <div
//                                 key={index}
//                                 className="relative bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-500 hover:scale-105 hover:shadow-2xl hover:bg-greenColor"
//                             >
//                                 <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-90 transition-opacity duration-300 hover:opacity-0"></div>
//                                 <div className="relative">
//                                     <img src={recipe.imageUrl} alt={recipe.recipeName} className="w-full h-48 object-cover" />
//                                     <div className="p-6">
//                                         <h3 className="text-2xl font-bold text-greenColor mb-2 hover:text-white">{recipe.recipeName}</h3>
//                                         <p className="text-gray-100 mt-2" dangerouslySetInnerHTML={{ __html: `${recipe.instructions.substring(0, 100)}...` }} />
//                                         <Link to={`/recipe/${recipe._id}`} className="inline-block mt-4 text-green-200 font-semibold hover:text-green-300">
//                                             Read More
//                                         </Link>
//                                     </div>
//                                 </div>
